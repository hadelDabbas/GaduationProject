    ...
    body: SingleChildScrollView(
      child: Container(
       ...
       Result('T','انتهى الوقت هل تريد اعادة اللعبة');
                         ...
                         icon: Icon(Icons.next_plan_sharp,color: Colors.black54,size: 40,),
                       ),
                         Padding(
                           padding: const EdgeInsets.all(8.0),
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text("قم  بانشاء  كلمة  من الحرو ف",style: TextStyle(fontSize: 22,
    ...
    Center(
      child: Container(   padding: const EdgeInsets.all(10),
            decoration: BoxDecoration(color: Color.fromARGB(255, 240, 230, 230),
              border: Border.all(  color: Color.fromARGB(255, 248, 231, 76),width: 1),
