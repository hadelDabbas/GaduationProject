...
//import 'package:getwidget/getwidget.dart';
 ...
 List <String> stringword=['قالب',"قلاب","قابل ","اقبل"];
   ...
   return Scaffold(
    ...
    Get.to(HomePage());
                    ...
                    child: Container( 
                                    ...
                                    color: Colors.white)),
                            Obx(() => Center(
                           child: Text('  ${controller.resulting.value}',
                           style: TextStyle(
                           color: Colors.white,  ),),  )),
                ...
                Padding(
                    ...
                    child: Container( 
                                     ...
                                     child: Row(children: [
                                        Text('   الصحيح  :', style: TextStyle(
                                       color: Colors.white)),
                            Obx(() => Center(
                           child: Text('  ${controller.correct.value}',
                           style: TextStyle(
                           color: Colors.white,  ),),  )),
              ...
              Result('G','تهانينا اجتزت هذا المستوى هل تريد الانتقال للمستوى التالي؟');
           ...
           Result('T','انتهى الوقت هل تريد اعادة اللعبة');
                           ...
                           icon: Icon(Icons.next_plan_sharp,color: Colors.grey[350],size: 40,),
                         ),
                           Padding(
                             padding: const EdgeInsets.all(8.0),
                             child: IconButton(onPressed:(){
                              controller.letters.remove(controller.letters.value.last);
                                                }, icon:Icon(Icons.backspace_outlined ,color: Colors.grey[350],
                                                size: 35,)),
                           ),
           Padding(
                               padding: const EdgeInsets.all(8.0),
                               child: Obx(() =>   Text('   '+controller.letters.join(),style: TextStyle(fontSize: 30,
    ...
    Center(
                ...
                createletter('ق')
                  ...
                  Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text("قم  بانشاء  كلمة  من  اربع  حروف",style: TextStyle(fontSize: 22,
...
// import 'package:flutter/material.dart';
// import 'package:get/get.dart';
// import 'package:graduationproject/models/letter_game/view/letter3.dart';
...
//     );}
    ...
    Center(
      child: Container(   padding: const EdgeInsets.all(10),
            decoration: BoxDecoration(color: Color.fromARGB(255, 240, 230, 230),
