...
class FoucsGameView5 extends GetResponsiveView<FoucsController>{
        ...
        child: Column(
          children: [
            ...
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Center(
                child: Text(' How many Cubes are there in the picture?',style: TextStyle(fontSize: 22,
                fontWeight: FontWeight.bold,
            ...
            SizedBox(height: 20,),
              Padding(
                   padding: const EdgeInsets.fromLTRB(10, 10, 8, 8),
                      ...
                      //   color: Colors.white,
                                child: 
                               Image.asset('assets/images/cubes.png')
                             ),
                                ),
                                  SizedBox(height: 30,),
