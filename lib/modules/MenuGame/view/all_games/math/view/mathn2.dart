...
import 'package:graduationproject/modules/MenuGame/view/all_games/math/view/math3new.dart';

import '../../../../Menu_game.dart';
import '../controller/math_controller.dart';

class MathNew2PageView extends GetResponsiveView<MathController> {
  MathController controller=Get.put(MathController());
  MathNew2PageView({super.key});
        ...
        children: [
          ...
          Container(
            ...
            child:  Padding(
              ...
              child: Column(
                children: [
                  Text('ما هي الأعداد الثلاثة المتتالية التي سوف ',
                      style: TextStyle(
                          color: Colors.black54,
                          fontSize: 30,
                          decoration: TextDecoration.none)),
                  Text('  يكون مجموعهم 36؟ ',
                      style: TextStyle(
                          color: Colors.black54,
                          fontSize: 30,
                          decoration: TextDecoration.none)),
          ...
          ShapeAnswer('11/11/12'),
          ShapeAnswer('11/12/12'),
          ShapeAnswer('11/12/13'),
        ],
      ),
    );
  }
