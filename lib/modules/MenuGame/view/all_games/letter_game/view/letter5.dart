...
import 'package:graduationproject/modules/MenuGame/view/all_games/letter_game/view/letter7.dart';

import '../controller/letter_controller.dart';

class Letter5pageview extends GetResponsiveView<LetterController> {
  Letter5pageview({super.key});

  @override
  Widget build(BuildContext context) {
    List<String> stringword = ["مرج", "رجم", "جمر", "جرم"];
    ...
    return Scaffold(
        ...
        body: Container(
          ...
          decoration: const BoxDecoration(
            ...
            colors: [
              Color.fromARGB(255, 240, 235, 233),
              Color.fromARGB(255, 61, 34, 24),
            ],
          )),
          child: Column(
            children: [
