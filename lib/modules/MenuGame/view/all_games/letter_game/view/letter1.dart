...
import 'package:graduationproject/modules/MenuGame/view/all_games/letter_game/view/letter22.dart';
...
class Letter1 extends GetResponsiveView<LetterController> {
  ...
  Widget build(BuildContext context) {
    List<String> stringword = ['ملح', "لحم", "حمل", "حلم", "محل"];
