...
class Formword7PageView extends GetResponsiveView<SplashScreencontroller> {
  SplashScreencontroller controller=Get.put(SplashScreencontroller());
  TimerController timerController=Get.put(TimerController());
   List <String> stringword=['دماغ','ناس','معلوماتية','طاقة'];
 ...
 @override
       ...
       child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      gradient: const LinearGradient(
                        colors: [Color.fromARGB(255, 2, 25, 44), Color.fromARGB(255, 180, 202, 240)],
                ...
                child: Container( 
                                 ...
                                 child: Row(children: [
                        Obx(() => Center(
                       child: Text('    '+controller.count7.value.toString(),
                       style: TextStyle(
                       color: Colors.white,  ),),  )),
  ...
  Widget Lettershape( String letter){
    return  Padding(
                ...
                child: ElevatedButton(  style: ButtonStyle(
                    backgroundColor: MaterialStateProperty.all(Color.fromARGB(255, 255, 111, 68)),),
                  onPressed: (){
        ...
        child: Column(children: [
          Center( child:  Text(txt,style: TextStyle(fontSize: 20,decoration: TextDecoration.none,
                    ...
                    TextButton(onPressed: (){
                         ...
                         style: TextStyle(color:Color.fromARGB(255, 255, 111, 68))
                        )),
                                TextButton(onPressed: (){
      ...
      child: Container(
        ...
        child: Center(child:
          Row(children: [
                              ...
                              color: Colors.deepOrange),),
                            Text((4- controller.count7.value).toString(),style: TextStyle(fontSize: 20,
                            decoration: TextDecoration.none,
                             color: Colors.deepOrange),)
                            ],),
       ),
                ...
                children: [
                 Text(controller.score.value.toString(),style:
                  TextStyle(fontWeight: FontWeight.bold,fontSize: 18),),
                   Text('Congratulations, You Win This Level',style: TextStyle(fontSize: 16,color: Color.fromARGB(255, 255, 111, 68)),),
                  Text('Do You Want To Go To Next Level',style: TextStyle(fontSize: 16,color: Color.fromARGB(255, 255, 111, 68)),),
                      Row(children: [
                         SizedBox(width: 40,),
                           TextButton(onPressed: (){
                            Get.to(Formword8PageView());
...
Future  TimeOff(){
    return Get.dialog(Align(alignment: Alignment.bottomCenter,
      child: Container(
        ...
        color: Colors.white,
        child: Column(children: [
            Text('Time Off Do You Want To contuine ? ',style: TextStyle(fontSize: 20,
            decoration: TextDecoration.none,
                              color: Color.fromARGB(255, 255, 111, 68)),),
          Row(children: [
