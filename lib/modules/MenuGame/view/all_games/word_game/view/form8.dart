       ...
       child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      gradient: const LinearGradient(
                        colors: [Color.fromARGB(255, 236, 132, 214), Color.fromARGB(255, 137, 170, 228)],
                ...
                child: Container( 
                                 ...
                                 child: Row(children: [
                        Obx(() => Center(
                       child: Text('    '+controller.count8.value.toString(),
                       style: TextStyle(
                       color: Colors.white,  ),),  )),
      ...
      child: Container(
        ...
        child: Center(child:
          Row(children: [
                            ...
                            Text((8- controller.count8.value).toString(),style: TextStyle(fontSize: 20,
                            decoration: TextDecoration.none,
                ...
                children: [
                 Text(controller.score.value.toString(),style:
                  TextStyle(fontWeight: FontWeight.bold,fontSize: 18),),
                   Text('Congratulations, You Win This Level',style: TextStyle(fontSize: 16,color: Colors.pink[200]),),
                  Text('Do You Want To Go To Next Level',style: TextStyle(fontSize: 16,color:Colors.pink[200]),),
                      Row(children: [
                         SizedBox(width: 40,),
                           TextButton(onPressed: (){
                            Get.to(Formword9PageView());
