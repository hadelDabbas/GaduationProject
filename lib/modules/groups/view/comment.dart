...
class Comment extends GetResponsiveView<GroupController> {
GroupController hcontroller = Get.put(GroupController());
            ...
            Container(
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.end, children: [
                  ...
                  IconButton(
                    ...
                    iconSize: 20.0,
                    onPressed: () {
                      controller.addcomment.value.IdPost=controller.IdPost;
